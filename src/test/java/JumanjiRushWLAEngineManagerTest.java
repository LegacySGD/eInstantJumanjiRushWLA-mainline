...
public class JumanjiRushWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JumanjiRushWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/JumanjiRushWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JumanjiRushWLAIW/InitOutcome.xml").getDocumentElement();
